...
######################################### @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	...
	yay
	yes | LC_ALL=en_US.UTF-8 sudo pacman --needed -S i3-gaps wireless_tools python-pip compton termite thunar pamixer papirus-icon-theme rofi ttf-dejavu neovim zsh polkit-gnome unclutter xcape pacman-contrib gsimplecal zsh-syntax-highlighting neofetch xorg-server xdg-user-dirs lightdm-gtk-greeter
	clear
